...
(function () {
  ...
  const NAV = [
    ...
    { id: "bestiary", label: "Compendium", icon: "bestiary", title: "Compendium", eyebrow: "Enemies & Allies" },
    { id: "party", label: "Party", icon: "party", title: "The Party", eyebrow: "Heroes & Sheets" },
